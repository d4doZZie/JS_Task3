...
function anyNumber(n){
  ...
  for(var i=1; i<=n; i++){  // This will increment our number by 1, Starting from 1, to the given number.
     ...
     results.push("oh")
      ...
      anyNumber(100)   // Function call and passing of 100 as argument. (part of the instruction)
        anyNumber(67)   //  Function called and passed any random number. (67 in this case as argument)
